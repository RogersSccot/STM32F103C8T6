...
void PID_Init(void) // PID参数初始化
{
    ...
    pid_speed_1.maxOutput = 10000; //__HAL_TIM_GetAutoreload(&PWM_TIM);
    ...
    pid_position_1.maxOutput = 10000; //__HAL_TIM_GetAutoreload(&PWM_TIM);
    ...
    pid_speed_2.maxOutput = 10000; //__HAL_TIM_GetAutoreload(&PWM_TIM);
    ...
    pid_position_2.maxOutput = 10000;//__HAL_TIM_GetAutoreload(&PWM_TIM);
    ...
    pid_line.maxOutput = __HAL_TIM_GetAutoreload(&PWM_TIM);
    pid_line.lastErr = 0;
    pid_line.output = 0;
    pid_line.kp = KP_line;
    pid_line.ki = KI_line;
