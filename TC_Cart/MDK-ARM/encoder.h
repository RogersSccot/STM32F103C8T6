...
#define MOTOR_SPEED_RERATIO 10u // 电机减速比
...
extern float motor1_Out, motor2_Out;
extern float Now_Position_1, Now_Position_2;
extern float Target_Speed_1, Target_Speed_2;
extern float Target_Speed_fixed_1, Target_Speed_fixed_2;
extern float Target_Position_1, Target_Position_2;
extern float Target_Position_fixed_1, Target_Position_fixed_2;
extern float speed, position;
extern float last_error_1, last_error_2;
